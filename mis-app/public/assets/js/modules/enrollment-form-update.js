$(document).ready(function () {
    $(".tab-wizard").steps({
        ...
        , onFinished: function (event, currentIndex) {
            ...
            $.ajax({
                type: 'PUT',
                url: '/enrollment-form/' + $("#form-enrollment-info").attr("data-id"),
                dataType: 'json',
...
function computeFee() {
    ...
    gCfee = dg__objectAssign(gCfee, {
        enrollment_id: $("#form-enrollment-info").attr("data-id"),
        subjects: gSubjects,
...
function getTotalDiscount() {
    ...
    gTotalFee = ((parseFloat($("#form-fees input[name=tuition_fee]").val(), 10) || 0) + parseFloat($("#form-fees input[name=lab_fee]").val(), 10) || 0) +
