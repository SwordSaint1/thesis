                        ...
                        <div class="box">
                            <div class="box-header with-border">
                                <div class="pull-right">
                                    <a href="/accounts/create" class="btn btn-success" type="button"> <span><i
                                                class="fa fa-edit"></i> Add Account</span> </a>
                                </div>
                                <h4 class="box-title"><strong>Account</strong> List</h4>
                            </div>
                            <div class="box-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn waves-effect waves-light btn btn-outline btn-info mb-5"
                                                            href="{{ route('accounts.edit', $user->id) }}">Manage</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
