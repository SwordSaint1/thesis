                ...
                <div class="box">
                    ...
                    <div class="box-header with-border">
                        <div class="pull-right">
                            <a class="btn waves-effect waves-light btn btn-outline btn-warning mb-5" id="student-delete"
                                data-link="{{ route('students.destroy', $student->id) }}" href="#"
                                data-id="{{ $student->id }}">Delete</a>
                            <a href="{{ $student->id }}/edit" class="btn btn-success" type="button"> <span><i
                                        class="fa fa-edit"></i> Manage</span> </a>
                        </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row invoice-info">
                            <div class="col-md-6 invoice-col">
                                <address>
                                    <strong class="text-blue fs-24">{{ $student->last_name }},
                                        {{ $student->first_name }}
                                        {{ $student->middle_name }}</strong><br>
                                    <strong>Mobile Number: {{ $student->mobile_number }} &nbsp;&nbsp;&nbsp;&nbsp; Email:
                                        {{ $student->email_address }}</strong>
                                </address>
                            </div>
                            <!-- /.col -->
                            ...
                            <div class="col-sm-12 invoice-col mb-15">
                                <div class="invoice-details row no-margin">
                                    <div class="col-md-6 col-lg-3"><b>Student Number: </b>{{ $student->student_number }}
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-3">
                                        <b>Outstanding Balance:</b> Php
                                        {{ number_format($enrollment_form->total_balance ?? 0, 2, '.', ',') }}
                                    </div>
                                </div>
                            </div>
                            <!-- /.col -->
                        ...
                        <ul class="nav nav-tabs customtab" role="tablist">
                            <li class="nav-item"> <a class="nav-link active" data-bs-toggle="tab" href="#home2"
                                    role="tab"><span class="hidden-sm-up"><i class="ion-home"></i></span> <span
                                        class="hidden-xs-down">Assessment History</span></a> </li>
                            <li class="nav-item"> <a class="nav-link" data-bs-toggle="tab" href="#profile2"
                                    role="tab"><span class="hidden-sm-up"><i class="ion-person"></i></span> <span
                                        class="hidden-xs-down">Transactions</span></a> </li>
                        </ul>
                        <!-- Tab panes -->
                                                    ...
                                                    <tbody>
                                                        @forelse($student->enrollment_form->reverse() as $enrollment_form)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>Php
                                                                    {{ number_format($enrollment_form->total_fee, 2, '.', ',') }}
                                                                </td>
                                                                <td>Php{{ number_format($enrollment_form->total_discount, 2, '.', ',') }}
                                                                </td>
                                                                <td>Php{{ number_format($enrollment_form->total_payable, 2, '.', ',') }}
                                                                </td>
                                                                <td>Php{{ number_format($enrollment_form->total_payments, 2, '.', ',') }}
                                                                </td>
                                                                <td>Php{{ number_format($enrollment_form->total_balance, 2, '.', ',') }}
                                                                </td>
                                                                <td>
                                                                    <a class="btn waves-effect waves-light btn btn-outline btn-info mb-5"
                                                                        href="{{ route('enrollment-form.show', $enrollment_form->id) }}">Details</a>
                                                                </td>
                                                            </tr>
                                                        ...
                                                        @forelse($student->enrollment_form->reverse() as $enrollment_form)
                                                            ...
                                                            @forelse($enrollment_form->payment->reverse() as $payment)
                                                                <tr>
                                                                    ...
                                                                    <td>Php{{ number_format($payment->amount, 2, '.', ',') }}
                                                                    </td>
                                                                </tr>
                                                            @empty
                                                            @endforelse
